...
def getPOTCAR(vaspFile):
    ...
    W_POTCAR_file = "W_POTCAR "
    Al_POTCAR_file = "Al_POTCAR "
    ...
    for i in range(0, len(elements)):
        ...
        elif "W" == str(elements[i]) :
            concat = concat + W_POTCAR_file
        elif "Al" == str(elements[i]) :
            concat = concat + Al_POTCAR_file
...
for i in indexLines:
    ...
    run = "python3 makeStr.py " + str(i) + " -species Co Al W"
    os.system(run)
