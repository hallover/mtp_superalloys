...
/*****************************************************************************
* This function works for a general case of any number of atoms (not only 8)
*****************************************************************************/
int getNumberOfAtoms(string head[])
{
   int numberOfAtoms;
   stringstream buffer(head[2]); // it asks for the 3rd (=2+1) line!!
   buffer >> numberOfAtoms;
...
int main()
{
   ...
   int numberOfAtoms = getNumberOfAtoms(head);
